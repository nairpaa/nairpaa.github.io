...
Pada [Cyber Kill Chain](/posts/what-is-red-teaming/#0x9---attack-lifecycle), *initial access* terjadi di tahap **Delivery** dan **Exploitation**.

Jika [Breanch Model](/posts/red-team-engagement/#0x3---breach-model) yang digunakan pada *engagement* bukan *assume breach*, *Red Teamer* perlu mencari cara untuk mendapakan *initial access*.
...
- [Attacking Login Portals](/posts/attacking-login-portals/)
- WiFi Pentest
- Web Pentest
- Android Pentest
- iOS Pentest
