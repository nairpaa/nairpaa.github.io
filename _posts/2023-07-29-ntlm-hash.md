...
tags: [red team, persistence, active directory hacking, windows hacking, post compromise attack, credential theft, mimikatz, cobalt strike, ntlm]     # TAG names should always be lowercase
author: nairpaa
---
